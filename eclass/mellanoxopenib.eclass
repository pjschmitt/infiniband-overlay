...
#http://www.mellanox.com/downloads/ofed/MLNX_OFED-4.2-1.2.0.0/MLNX_OFED_SRC-4.2-1.2.0.0.tgz
...
OFED_BASE_VER=$(get_version_component_range 1-4 ${OFED_VER})

	SRC_URI="http://www.mellanox.com/downloads/ofed/MLNX_OFED-4.2-1.2.0.0/MLNX_OFED_SRC-${OFED_VER}.tgz"
#if [ -z $OFED_RC ] ; then
